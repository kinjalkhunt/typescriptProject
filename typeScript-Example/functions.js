...
var findMaxNumber = function (numbers) {
    var values = Object.keys(numbers).map(function (key) { return numbers[key]; }); // Extract values from the object
    var maxNumber = Math.max.apply(Math, values); // Find the maximum value
    return maxNumber;
};
var numberObject = { a: 1, b: 16, c: 8, d: 12, e: 2, f: 7, g: 23, h: 5 };
